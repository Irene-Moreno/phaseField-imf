...
private:
	...
	double AcV = userInputs.get_model_constant_double("AcV");
	double nT = userInputs.get_model_constant_double("nT");

	double cTcV = nT/(100*100*100);  // The system's dimensions should be stored somewhere
